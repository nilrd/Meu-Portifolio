          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                Especialista em <strong className="text-gray-900 dark:text-white">Quality Assurance</strong> com experiência em automação de testes e 
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Link
                  to="/sobre"
                  className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-semibold rounded-xl hover:shadow-lg transform hover:scale-105 transition-all duration-200"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 border-2 border-indigo-600 text-indigo-600 dark:text-indigo-400 dark:border-indigo-400 font-semibold rounded-xl hover:bg-indigo-600 hover:text-white dark:hover:bg-indigo-500 transition-all duration-200"
                >
              ...
              <div className="grid grid-cols-3 gap-4 sm:gap-6">
                <div className="text-center">
                  <div className="text-2xl sm:text-3xl font-bold text-indigo-600 dark:text-indigo-400">4+</div>
                  <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 leading-tight">Experiência em Qualidade de Software</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl sm:text-3xl font-bold text-purple-600 dark:text-purple-400">5+</div>
                  <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Projetos Principais</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl sm:text-3xl font-bold text-emerald-600 dark:text-emerald-400">9+</div>
                  <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Tecnologias</div>
                </div>
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2 lg:text-center">
              <div className="relative">
                <div className="bg-gradient-to-br from-gray-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 rounded-3xl p-6 sm:p-8 shadow-xl border border-gray-200 dark:border-gray-600 transition-colors duration-300">
                  <div className="flex flex-col items-center text-center">
                    <div className="relative mb-6">
                      <div className="absolute inset-0 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-full animate-spin-slow opacity-75"></div>
                      ...
                      <div className="absolute -top-2 -right-2 bg-gradient-to-r from-emerald-500 to-indigo-500 text-white p-2 rounded-full shadow-lg animate-bounce">
