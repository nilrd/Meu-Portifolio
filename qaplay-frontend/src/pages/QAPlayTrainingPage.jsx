...
const QAPlayTrainingPage = () => {
  ...
  const startGame = () => {
    const shuffledQuestions = shuffleArray([...allMixedQuestions]);
    const selected20Questions = shuffledQuestions.slice(0, 20); // Seleciona as primeiras 20 questões
    setCurrentQuestions(selected20Questions);
    setGameStarted(true);
